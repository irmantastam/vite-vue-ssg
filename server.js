...
const isStatic = process.env.SERVE_STATIC === 'true'
const port = process.env.PORT || 5173
const base = process.env.BASE || '/'

// Cached production assets
const templateHtml = isProduction
  ? await fs.readFile(isStatic ? './dist/static/index.html' : './dist/client/index.html', 'utf-8')
  : ''
const ssrManifest =
  isProduction && !isStatic
...
// Start http server
export const server = await createServer().then(({ server, vite }) => {
